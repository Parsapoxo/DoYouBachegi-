...
**Others (single movies, shown in Pixar's own "Others" row):** `up.png`, `walle.png`, `ratatouille.png`, `coco.png`
...
**Others (single movies, shown in DreamWorks's own "Others" row):** `beemovie.png`, `megamind.png`
...
1. Bump `APP_VERSION` (e.g. `1.1.0` → `1.2.0` for a new feature, `1.1.1` for a small fix).
